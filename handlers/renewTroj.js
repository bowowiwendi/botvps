...
// Fungsi untuk renew Trojan di VPS dengan quota dan limit IP
const renewTroj = (vpsHost, username, exp, quota, limitIp, callback) => {
            ...
            if (data.startsWith('troj_renew_')) {
                ...
                bot.once('message', async (msg) => {
                    ...
                    checkUsernameExists(server.host, username, (exists) => {
                        ...
                        renewTroj(server.host, username, exp, quota, limitIp, (result) => {
