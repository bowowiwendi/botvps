...
// Fungsi untuk renew Shadowsocks di VPS dengan quota dan limit IP
const renewSS = (vpsHost, username, exp, quota, limitIp, callback) => {
            ...
            if (data.startsWith('ss_renew_')) {
                ...
                bot.once('message', async (msg) => {
                    ...
                    checkUsernameExists(server.host, username, (exists) => {
                        ...
                        renewSS(server.host, username, exp, quota, limitIp, (result) => {
